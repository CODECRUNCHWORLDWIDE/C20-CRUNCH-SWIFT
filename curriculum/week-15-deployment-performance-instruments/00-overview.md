...
| [resources.md](./01-resources.md) | Apple's code-signing guide, the Instruments docs, the WWDC performance sessions (hitches, hangs, MetricKit), and the canonical community writing on profiling SwiftUI |
| [lecture-notes/01-deployment-and-code-signing.md](./02-lecture-notes/01-deployment-and-code-signing.md) | Code signing demystified end to end — certificate, App ID, provisioning profile, entitlements, automatic vs manual signing, deploying to a device, and the common errors decoded |
| [lecture-notes/02-instruments-hangs-hitches-and-metrickit.md](./02-lecture-notes/02-instruments-hangs-hitches-and-metrickit.md) | The performance mental model, the frame budget, the right Instrument for each problem, reading a flame graph, `os_signpost`, and MetricKit field telemetry — with the measure-fix-measure loop |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-deploy-and-read-the-profile.md](./03-exercises/exercise-01-deploy-and-read-the-profile.md) | Deploy a build to your device, run the Time Profiler, and read a flame graph to locate the heaviest stack |
| [exercises/exercise-02-find-and-fix-a-hang.swift](./03-exercises/exercise-02-find-and-fix-a-hang.swift) | Plant a deliberate main-thread hang, find it in the Hangs instrument, move the work off-main with structured concurrency, and prove it's gone |
| [exercises/exercise-03-signposts-and-metrickit.swift](./03-exercises/exercise-03-signposts-and-metrickit.swift) | Instrument an operation with `OSSignposter`, see it in the trace, and wire a MetricKit subscriber that logs the daily payloads |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the challenge |
| [challenges/challenge-01-hitch-then-fix.md](./04-challenges/challenge-01-hitch-then-fix.md) | Plant a scroll hitch (image decode on the render path), measure the hitch ratio in the Animation Hitches instrument, fix it, and document the before/after with traces |
| [quiz.md](./05-quiz.md) | 13 questions on code signing, the frame budget, the right Instrument per problem, hangs vs hitches vs leaks, signposts, and MetricKit |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Full spec for "Notes v1 — profiled on-device": deploy, find and fix a hang and a hitch, ship a MetricKit collector, prove it with traces |
