...
When you've finished all six, push your repo and open the [mini-project](./mini-project/README.md). The homework problems are deliberately the building blocks of the mini-project: problem 2 is its migration discipline, problem 4 is its no-storm requirement, and problem 1 is the code-review skill the whole week earns.
