...
If you scored under 9, re-read the lectures for the questions you missed — especially Q4 (per-property tracking), Q6 (the `@Bindable var x = x` idiom), and Q12 (draft-and-commit), which are the load-bearing ideas of the week. If you scored 11 or 12, you're ready for the [homework](./06-homework.md) and the mini-project.
