...
If you scored under 10, re-read the lectures for the questions you missed — especially the hop-counting (Q3, Q13) and reentrancy (Q4, Q10) items, which the mini-project leans on hardest. If you scored 12 or 13, you're ready for the [homework](./homework.md).
