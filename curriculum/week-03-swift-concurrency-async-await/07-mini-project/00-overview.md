...
- Add `--retry N` with bounded retries and jittered backoff — that's **[Challenge 1](../04-challenges/challenge-01-retry-with-bounded-concurrency.md)**, which builds directly on this.
