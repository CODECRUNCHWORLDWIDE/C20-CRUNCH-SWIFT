...
| **Mental model** | 30% | Notes correctly articulate the state→view loop, identity, modifier-order composition, and `body` purity — in the student's own words, not copied. |
