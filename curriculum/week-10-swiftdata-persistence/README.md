...
| [resources.md](./resources.md) | Apple's SwiftData docs, the WWDC SwiftData sessions, Core Data lineage reading, and the canonical community writing on migrations and performance |
| [lecture-notes/01-swiftdata-and-the-core-data-lineage.md](./lecture-notes/01-swiftdata-and-the-core-data-lineage.md) | SwiftData end to end: what it solves, what it still hides, the `@Model`/`@Attribute`/`@Relationship` macros, container/context, `@Query`, `#Predicate`, faulting, and where it leaks Core Data |
| [lecture-notes/02-coexistence-migrations-and-footguns.md](./lecture-notes/02-coexistence-migrations-and-footguns.md) | The SwiftData / Core Data co-existence pattern, lightweight vs custom migrations with `VersionedSchema`, and the performance footguns with measured before/after |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-model-container-survives-relaunch.md](./exercises/exercise-01-model-container-survives-relaunch.md) | Define `@Model` types, wire a `ModelContainer`, persist records, and prove they survive a force-quit relaunch |
| [exercises/exercise-02-query-predicate-vs-naive.swift](./exercises/exercise-02-query-predicate-vs-naive.swift) | Query with `@Query` + `#Predicate` + sort descriptors and measure naive-in-memory vs predicate-in-SQLite cost |
| [exercises/exercise-03-lightweight-migration.swift](./exercises/exercise-03-lightweight-migration.swift) | Introduce a schema change and apply a lightweight migration with `VersionedSchema` + `SchemaMigrationPlan` |
| [challenges/README.md](./challenges/README.md) | Index of the challenge |
| [challenges/challenge-01-footgun-then-refactor.md](./challenges/challenge-01-footgun-then-refactor.md) | Plant a deliberate fetch-everything-then-filter footgun, refactor it into a `#Predicate`-driven query, and document the before/after timing |
| [quiz.md](./quiz.md) | 13 questions on the lineage, macros, container/context, `@Query`/`#Predicate`, migrations, and footguns |
| [homework.md](./homework.md) | Six practice problems for the week |
| [mini-project/README.md](./mini-project/README.md) | Full spec for "Hello, Notes — SwiftData edition": migrate off `NotesStore`, add a `Tag` many-to-many, query by tag, survive relaunch |
