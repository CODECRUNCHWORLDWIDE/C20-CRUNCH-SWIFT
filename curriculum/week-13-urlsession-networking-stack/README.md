...
| [resources.md](./resources.md) | Apple's URLSession and Codable docs, the WWDC networking sessions, the Vapor refresher, and the canonical community writing on retries, errors, and offline-first |
| [lecture-notes/01-from-one-line-to-a-typed-client.md](./lecture-notes/01-from-one-line-to-a-typed-client.md) | From `URLSession.shared.data` to a typed `Endpoint`-driven actor client: configuration, async APIs, `Codable` decoding strategies, typed errors, and `URLProtocol` hermetic testing |
| [lecture-notes/02-resilience-retries-signing-and-offline-first.md](./lecture-notes/02-resilience-retries-signing-and-offline-first.md) | The resilient client: retry with exponential backoff and jitter, request signing and logging middleware, offline detection, and the offline-first write-replay/outbox pattern against SwiftData |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-typed-endpoint-client.md](./exercises/exercise-01-typed-endpoint-client.md) | Build a generic `Endpoint` and a `send` method, decode a real `Codable` response, and map failures into a typed `NetworkError` |
| [exercises/exercise-02-urlprotocol-stub-tests.swift](./exercises/exercise-02-urlprotocol-stub-tests.swift) | Write a stub `URLProtocol` and test the client hermetically — success, an HTTP 500, a decode failure, and an offline error — with zero network |
| [exercises/exercise-03-retry-backoff-jitter.swift](./exercises/exercise-03-retry-backoff-jitter.swift) | Implement retry-with-exponential-backoff-and-jitter, prove it retries the right errors, stops at the cap, respects cancellation, and that jitter spreads the delays |
| [challenges/README.md](./challenges/README.md) | Index of the challenge |
| [challenges/challenge-01-offline-write-replay.md](./challenges/challenge-01-offline-write-replay.md) | Build an offline-first write-replay outbox: queue mutations while offline, replay them in order on reconnect, make replay idempotent, and prove it with a simulated network drop |
| [quiz.md](./quiz.md) | 14 questions on configuration, async APIs, typed errors, decoding, retries/jitter, signing, `URLProtocol`, and offline-first |
| [homework.md](./homework.md) | Six practice problems for the week |
| [mini-project/README.md](./mini-project/README.md) | Full spec for wiring "Notes v1" to the Vapor `notes-api` with a `NotesClient` actor — structured errors, retries, offline detection, and SwiftData write-replay |
