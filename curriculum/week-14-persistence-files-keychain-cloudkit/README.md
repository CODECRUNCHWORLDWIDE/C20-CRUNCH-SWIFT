...
| [resources.md](./resources.md) | Apple's File System Programming Guide, the Keychain Services reference, the SwiftData + CloudKit articles, the WWDC sessions, and the canonical community writing on Keychain wrappers and conflict resolution |
| [lecture-notes/01-files-and-the-keychain.md](./lecture-notes/01-files-and-the-keychain.md) | The decision tree, the sandbox, `FileManager`, atomic writes, file coordination, App Groups, and the Keychain end to end — the C API, the accessibility classes, and a typed `KeychainStore` |
| [lecture-notes/02-swiftdata-cloudkit-and-conflict-resolution.md](./lecture-notes/02-swiftdata-cloudkit-and-conflict-resolution.md) | Turning on CloudKit sync, the schema constraints CloudKit imposes, what a conflict is, and a deterministic resolution policy with measured before/after |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-sandbox-and-atomic-writes.md](./exercises/exercise-01-sandbox-and-atomic-writes.md) | Map the sandbox, write a file atomically to the right directory, exclude a cache from backup, and prove it with the file inspector |
| [exercises/exercise-02-keychain-store.swift](./exercises/exercise-02-keychain-store.swift) | Wrap the Keychain C API in a typed `KeychainStore`, store and read a token with the correct accessibility class, and test the round-trip |
| [exercises/exercise-03-cloudkit-conflict-resolution.swift](./exercises/exercise-03-cloudkit-conflict-resolution.swift) | Model a CloudKit-safe `@Model`, simulate a two-device conflict, and resolve it with a deterministic last-write-wins policy |
| [challenges/README.md](./challenges/README.md) | Index of the challenge |
| [challenges/challenge-01-token-leak-then-lockdown.md](./challenges/challenge-01-token-leak-then-lockdown.md) | Plant the classic "token in `UserDefaults`" leak, prove it leaks (read it out of the backup), then lock it down in the Keychain with the right accessibility class — and document the threat each step closes |
| [quiz.md](./quiz.md) | 13 questions on the decision tree, the sandbox, atomic writes, the Keychain, CloudKit constraints, and conflict resolution |
| [homework.md](./homework.md) | Six practice problems for the week |
| [mini-project/README.md](./mini-project/README.md) | Full spec for "Notes v1 — Keychain + CloudKit edition": store the token in the Keychain, sync over CloudKit, reproduce and resolve a two-device conflict |
