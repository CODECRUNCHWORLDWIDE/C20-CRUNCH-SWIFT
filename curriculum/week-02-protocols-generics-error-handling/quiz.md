...
If you scored under 10, re-read the lectures for the questions you missed — especially the dispatch gotcha (Q2) and the `some`/`any` decision matrix (Q5, Q6, Q13). If you scored 12 or 13, you're ready to dive into the [homework](./homework.md).
