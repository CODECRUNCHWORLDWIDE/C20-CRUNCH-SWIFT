...
This challenge compounds directly on the [mini-project](../mini-project/README.md): you build the `Cache<Key, Value>` there first, then graft a pluggable eviction policy onto it here. Do the mini-project first, or at least the in-memory store, before you start.
