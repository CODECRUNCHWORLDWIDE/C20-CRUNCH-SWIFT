...
- [week 01 swift the language](./curriculum/week-01-swift-the-language/00-overview.md)
- [week 02 protocols generics error handling](./curriculum/week-02-protocols-generics-error-handling/00-overview.md)
- [week 03 swift concurrency async await](./curriculum/week-03-swift-concurrency-async-await/00-overview.md)
- [week 04 actors sendable strict concurrency](./curriculum/week-04-actors-sendable-strict-concurrency/00-overview.md)
- [week 05 vapor server side swift](./curriculum/week-05-vapor-server-side-swift/00-overview.md)
- [week 06 shared types swift nio integration](./curriculum/week-06-shared-types-swift-nio-integration/00-overview.md)
- [week 07 xcode swiftui mental model](./curriculum/week-07-xcode-swiftui-mental-model/00-overview.md)
- [week 08 state observable environment bindable](./curriculum/week-08-state-observable-environment-bindable/00-overview.md)
- [week 09 navigation deep links scenes](./curriculum/week-09-navigation-deep-links-scenes/00-overview.md)
- [week 10 swiftdata persistence](./curriculum/week-10-swiftdata-persistence/00-overview.md)
- [week 11 app architecture mvvm tca](./curriculum/week-11-app-architecture-mvvm-tca/00-overview.md)
- [week 12 combine async asyncsequence](./curriculum/week-12-combine-async-asyncsequence/00-overview.md)
- [week 13 urlsession networking stack](./curriculum/week-13-urlsession-networking-stack/00-overview.md)
- [week 14 persistence files keychain cloudkit](./curriculum/week-14-persistence-files-keychain-cloudkit/00-overview.md)
- [week 15 deployment performance instruments](./curriculum/week-15-deployment-performance-instruments/00-overview.md)
- [week 16 accessibility inclusive engineering](./curriculum/week-16-accessibility-inclusive-engineering/00-overview.md)
- [week 17 security cryptokit secure enclave](./curriculum/week-17-security-cryptokit-secure-enclave/00-overview.md)
- [week 18 push storekit metrickit](./curriculum/week-18-push-storekit-metrickit/00-overview.md)
- [week 19 multi platform targets](./curriculum/week-19-multi-platform-targets/00-overview.md)
- [week 20 widgets app intents spotlight](./curriculum/week-20-widgets-app-intents-spotlight/00-overview.md)
- [week 21 live activities background processing](./curriculum/week-21-live-activities-background-processing/00-overview.md)
- [week 22 testing ci fastlane](./curriculum/week-22-testing-ci-fastlane/00-overview.md)
- [week 23 capstone build sprint](./curriculum/week-23-capstone-build-sprint/00-overview.md)
- [week 24 testflight app review chaos drill](./curriculum/week-24-testflight-app-review-chaos-drill/00-overview.md)
